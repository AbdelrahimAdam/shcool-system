    ...
    <nav class="p-4">
      <div class="space-y-1">
        <router-link 
          ...
          :class="{ 'bg-primary-50 text-primary-600': $route.path === '/accountant' }"
        >
        ...
        <router-link 
          ...
          class="flex items-center px-4 py-3 rounded-lg hover:bg-gray-100 transition-colors"
          :class="{ 'bg-primary-50 text-primary-600': $route.path === '/accountant/payments' }"
        >
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <router-link 
          ...
          class="flex items-center px-4 py-3 rounded-lg hover:bg-gray-100 transition-colors"
          :class="{ 'bg-primary-50 text-primary-600': $route.path === '/accountant/reports' }"
        >
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
