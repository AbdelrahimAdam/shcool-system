    ...
    <div v-if="showRequestModal" class="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4" @click.self="closeRequestModal">
      <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <form @submit.prevent="submitPaymentRequest" class="p-6 space-y-4">
          ...
          <div v-if="schoolBankak" class="bg-blue-50 rounded-xl p-4 border border-blue-100">
            ...
            <div v-if="schoolBankak.accountNumber && schoolBankak.accountName" class="space-y-1.5 text-sm">
          ...
          <div v-if="schoolBankak?.accountNumber && schoolBankak?.accountName" class="bg-green-50 rounded-xl p-4 border border-green-100">
            <div class="flex items-center gap-2 mb-2">
